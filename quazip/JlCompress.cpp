...
QStringList JlCompress::extractDir(QString fileCompressed, QStringConverter::Encoding  fileNameEncoding, QString dir) {
    // Apro lo zip
    QuaZip zip(fileCompressed);
    if (fileNameEncoding)
        zip.setFileNameEncoding(fileNameEncoding);
    return extractDir(zip, dir);
}

QStringList JlCompress::extractDir(QString fileCompressed, QString dir) {
    return extractDir(fileCompressed, QStringConverter::System, dir);
}
...
QStringList JlCompress::extractDir(QIODevice* ioDevice, QStringConverter::Encoding  fileNameEncoding, QString dir)
{
    QuaZip zip(ioDevice);
    if (fileNameEncoding)
        zip.setFileNameEncoding(fileNameEncoding);
...
{
    return extractDir(ioDevice, QStringConverter::System, dir);
}
