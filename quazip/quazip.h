 ...
 * have to set up proper codec with setEncoding() function. By default,
...
class QUAZIP_EXPORT QuaZip {
  ...
  public:
    ...
    /// Sets the codec used to encode/decode file names inside archive.
    /** \overload
     * Equivalent to calling setFileNameEncoding(QTextEncoding::codecForName(codecName));
     **/
    void setFileNameEncoding(const char *fileNameEncodingName);
     ...
     **/
    void setCommentEncoding(QStringConverter::Encoding commentEncoding);
    /// Sets the codec used to encode/decode comments inside archive.
    /** \overload
     * Equivalent to calling setCommentEncoding(QTextEncoding::codecForName(codecName));
     **/
    void setCommentEncoding(const char *commentEncodingName);
    /// Returns the codec used to encode/decode comments inside archive.
     ...
     * Should be used only in QuaZip::mdUnzip mode.
     *
     * \sa setFileNameEncoding(), CaseSensitivity
     **/
     ...
     *
     * The codec specified here can be overriden by calling setFileNameEncoding().
     * If neither function is called, QTextEncoding::codecForLocale() will be used
     ...
     * encoding.
     *
     * In most cases, using setFileNameEncoding() instead is the right choice.
     ...
     *
     * In short: use setFileNameEncoding() when you can, resort to
     * setDefaultFileNameEncoding() when you don't have access to the QuaZip
     * instance.
     *
     * @param codec The codec to use by default. If null, resets to default.
     */
    static void setDefaultFileNameEncoding(QStringConverter::Encoding codec);
    /**
     * @overload
     * Equivalent to calling
     * setDefaultFileNameEncoding(QTextEncoding::codecForName(codecName)).
     */
    static void setDefaultFileNameEncoding(const char *codecName);
