...
public:
    ...
    /**
      \param fileCompressed The name of the archive.
      \param fileNameEncoding The codec to use for file names.
      \param dir The directory to extract to, the current directory if
      left empty.
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QStringList extractDir(QString fileCompressed, QStringConverter::Encoding  fileNameEncoding, QString dir = QString());
    /// Get the file list.
    /**
    ...
    /**
      ...
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QStringList extractDir(QIODevice* ioDevice, QStringConverter::Encoding  fileNameEncoding, QString dir = QString());
    /// Get the file list.
    /**
      \return The list of the files in the archive, or, more precisely, the
      list of the entries, including both files and directories if they
