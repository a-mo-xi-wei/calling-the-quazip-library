...
void TestQuaZipFile::zipUnzip_data()
{
    ...
    QTest::addColumn<QByteArray>("fileNameEncoding");
...
void TestQuaZipFile::zipUnzip()
{
    ...
    QFETCH(QByteArray, fileNameEncoding);
    ...
    if (!fileNameEncoding.isEmpty())
        testZip.setFileNameEncoding(fileNameEncoding);
    ...
    if (!fileNameEncoding.isEmpty())
        testUnzip.setFileNameEncoding(fileNameEncoding);
